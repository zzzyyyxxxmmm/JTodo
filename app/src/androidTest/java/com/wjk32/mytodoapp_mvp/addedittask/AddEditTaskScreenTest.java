...
import com.wjk32.mytodoapp_mvp.TestUtils;
...
import static com.wjk32.mytodoapp_mvp.R.id.toolbar;
/**
...
public class AddEditTaskScreenTest {
    ...
    public void emptyTask_isNotSaved() {
        ...
        onView(ViewMatchers.withId(R.id.add_task_title)).perform(clearText());
